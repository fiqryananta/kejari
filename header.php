...
<head>
    <title>Kejaksaan Negeri Semarang</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/plugins/dropzone.min.css">
		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item"><a href="animation.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-aperture"></i></span><span class="pcoded-mtext">Dashboard</span></a></li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Jenis Surat</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo base_url(); ?>in6">I.N 6</a></li>
